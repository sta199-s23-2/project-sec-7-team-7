...
As cholesterol increases, heart disease rates increase. *For the data entries with cholesterol of 0, there are high rates of heart disease, but should this be filtered out because chol = 0 is impossible and should not be in data set?*
